...
# OWASP LLM Top 10 → sentrix plugin/scanner mapping
_OWASP_CONTROLS = [
    {
        "control_id": "LLM01",
...
class ComplianceReport:
    ...
    def summary(self) -> None:
        ...
        print(f"\n[sentrix] Compliance Report — {self.framework.upper()}")
...
<html>
<head>
<title>sentrix Compliance Report — {self.framework}</title>
<style>
...
<body>
<h1>sentrix Compliance Report</h1>
...
<p style="margin-top:40px;color:#888;font-size:12px">Generated by <a href="https://github.com/pinexai/sentrix">sentrix</a></p>
</body>
</html>"""
        with open(path, "w") as f:
            f.write(html)
        print(f"[sentrix] Compliance report saved to {path}")
    ...
    for control in controls:
        ...
        if plugin is None or rate is None:
            ...
            if not scans:
                ...
                remediation = f"Run sentrix scan to test {control['control_name']}"
            else:
                status = "partial"
