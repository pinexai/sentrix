...
def auto_dataset(
    ...
    Args:
        ...
        db_path: optional path to sentrix SQLite database
    ...
    print(f"[sentrix] Generating {n} test cases for {fn_name!r} (focus={focus!r})...")
    ...
    print(f"[sentrix] Generated {len(ds)} test cases")
    return ds
