...
class ModelFingerprint:
    ...
    def summary(self) -> None:
        print(f"\n[sentrix] Model Fingerprint Summary")
    ...
    def _persist(self) -> None:
        try:
            ...
            print(f"[sentrix] Warning: could not persist fingerprint: {e}")
...
def fingerprint(
    ...
    print(f"\n[sentrix] Fingerprinting {len(model_names)} model(s) across {len(plugin_names)} attack plugin(s)...")
