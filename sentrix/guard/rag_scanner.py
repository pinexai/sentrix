...
class RAGScanReport:
    ...
    def summary(self) -> None:
        print(f"\n[sentrix] RAG Security Scan Report")
    ...
    def _persist(self) -> None:
        try:
            ...
            print(f"[sentrix] Warning: could not persist RAG report: {e}")
...
def scan_rag(
    ...
    print(f"[sentrix] Scanning {len(documents)} documents for security issues...")
